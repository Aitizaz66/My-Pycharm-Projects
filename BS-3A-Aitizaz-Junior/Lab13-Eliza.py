...
rules = [
    ...
    ("?*X MOTHER ?*Y", [
        ...
        "How does your mother relate to this problem?"
    ]),
    ("?*X I HAVE TO ?*Y BUT ?*Z", [
        "What makes it hard to ?Y because of ?Z?",
        "Why does ?Z stop you from doing ?Y?"
    ]),
    ("?*X I WILL ?*Y WHEN ?*Z", [
        "Why do you need to wait until ?Z to ?Y?",
        "What will change when ?Z happens?"
    ]),
]
